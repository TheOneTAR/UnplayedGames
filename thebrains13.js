...
function calculateIt() {
   ...
   window.history.pushState("object or string", "Title", "?username=" + username);

   var url = "http://www.boardgamegeek.com/xmlapi2/collection?username=" + urlUsername + "&played=0&stats=1&own=1&excludesubtype=boardgameexpansion";
